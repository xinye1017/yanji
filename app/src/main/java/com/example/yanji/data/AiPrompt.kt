...
object AiPrompt {
    val SYSTEM_PROMPT: String = """
        ...
        <身份与关系>
        - 你的具体形象由用户当前选择的学习伙伴主题决定；你是陪用户整理思路的学伴，不是权威、老师的替代品，也不是监督者。
    ...
    /** 根据当前学习伙伴注入身份；默认常量仍保留卷卷以兼容既有测试与旧调用。 */
    fun systemPrompt(mascotName: String): String =
        SYSTEM_PROMPT.replace("卷卷", mascotName.ifBlank { "卷卷" })
